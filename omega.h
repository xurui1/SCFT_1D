void omega(double **w){
    ...
    if (initial==0){
        for(i=0;i<Nr;i++){
            w[0][i]=-5.0*cos(4.0*Pi*(double)i/(double)Nr)+(double)((rand() %100)/100.0);
            w[1][i]=5.0*cos(4.0*Pi*(double)i/(double)Nr)+(double)((rand() %100)/100.0);
            w[2][i]=10.0+(double)((rand() %100)/100.0);
        }
    }
